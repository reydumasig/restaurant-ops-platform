  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed inset-y-0 z-50 flex h-full w-64 max-w-[calc(100%-3rem)] flex-col gap-1 bg-background p-4 shadow-lg outline-none duration-150 data-open:animate-in data-closed:animate-out",
          side === "left" &&
